...
def test_access():
    ...
    src = "0x1E9eb2b168993C1c4e79a4B1A7082a1BDA1D3234"  # SWITCH1_ADDRESS
    dst = "0xac7c33305CaAB6e53955876374B97ED6203AD1D7"  # SWITCH2_ADDRESS
    make_request(f'http://localhost:5000/check_access/{src}/{dst}')

def test_certificate():
    print("\nTesting certificate check:")
    address = "0xC184836543aBd0B70ffb2A8083eEf57F829ACD62"  # SWITCH1_ADDRESS
